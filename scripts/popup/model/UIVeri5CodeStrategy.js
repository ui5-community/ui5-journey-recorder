sap.ui.define([
    ...
    UIVeri5CodeStrategy.prototype.generate = function (oCodeSettings, aElements, oCodeHelper) {
        var aCodes = [];
    ...
    UIVeri5CodeStrategy.prototype.createTestStep = function (oCodeSettings, oElement) {
        var sCode = "";
        var aCode = [];
    ...
    UIVeri5CodeStrategy.prototype._groupCodeByCluster = function (aElements) {
        var aCluster = [[]];
    ...
    UIVeri5CodeStrategy.prototype._getUI5Element = function (oElement, oUI5Selector, oAssert) {
        var bMulti = false;
        //var sElementName = "";
