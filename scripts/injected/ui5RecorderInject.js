...
if (typeof sap === "undefined" || typeof sap.ui === "undefined" || typeof sap.ui.getCore === "undefined" || !sap.ui.getCore() || !sap.ui.getCore().isInitialized()) {
    ...
    sap.ui.require([
    ...
    ], function(BaseObject, JSONModel, MessageToast, ValueState) {
        "use strict";
        ...
        handleEvent: function (sEventType, oEventData) {
        ...
        fireEventToContent: function (sEventType, oEventData) {
        ...
        onClick: function (oDomNode, bAssertion) {
        ...
        _setWindowLocation: function (oEventData) {
            window.location.href = oEventData.url;
        },
        
        _doReplaySteps: function () {
            //go over all steps
        },
        
        _getDataModelInformation: function () {
        ...
        _selectItem: function (oEventData) {
        ...
        _getControlFromDom: function (oDomNode) {
            var oControls = [];
            if (oDomNode.id) {
        ...
        _getFinalDomNode: function (oElement) {
        ...
        _executeAction: function (oEventData) {
            this.unlockScreen();
        ...
        _getAllChildrenOfDom: function (oDom, oControl) {
        ...
        _getAllChildrenOfObject: function (oItem) {
            if (!oItem.dom) {
                return [];
            }
        ...
        _getFoundElements: function (sString) {
        ...
        _showItemControl: function (oControl) {
        ...
        _runSupportAssistant: function (oComponent) {
            return new Promise(function (resolve, reject) {
        ...
        _setUniqunessInformationElement: function (oItem) {
            var iUniqueness = 0;
        ...
        _setUniqunessInformation: function (oItem) {
            oItem = this._setUniqunessInformationElement(oItem);
            return oItem;
        },
    
        _navigateToListItem: function (oItem) {
        ...
        _setItem: function (oControl, oDomNode, oOriginalDomNode) {
            //@Adrian - Fix bnd-ctxt uiveri5 2019/06/25
        ...
        _removeNonSerializable: function (oItem) {
        ...
        _removeNonSerializableData: function (oItem) {
            if (!oItem) {
                return;
            }
        ...
        __showFastInformation: function (event) {
        ...
        _getParentWithDom: function (oItem, iCounter, bViewOnly) {
        ...
        _getItemDataForItem: function (oItem) {
        ...
        _getLabelForItem: function (oItem) {
            if (oItem.label) {
                return oItem.label;
            }
        ...
        _getElementInformation: function (oItem, oDomNode, bFull) {
            var oReturn = {
                property: {},
                aggregation: {},
                association: {},
