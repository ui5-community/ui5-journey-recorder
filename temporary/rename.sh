...
do 
    ...
    sed -i "/import { TSTemplate, JSTemplate, TSImportTemplate, JSImportTemplate, TSGeneralPageTemplate } from '.\/wdi5Templates';/c\import { TSTemplate, JSTemplate, TSImportTemplate, JSImportTemplate, TSGeneralPageTemplate } from '.\/wdi5Templates.mjs';" "$file"
