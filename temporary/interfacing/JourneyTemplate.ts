...
module.exports = class JourneyTemplate extends RootTemplate {
    ...
    private _pages: Record<string, typeof PageTemplate> = {};
    ...
    extractSteps(oJourneyJSON: Record<string, unknown>): JourneyTemplate {
        ...
        this._steps = aSteps.map((oStep: Record<string, unknown>) => {
            ...
            this._pages[sPageName].addMethod(oStep.step);
    ...
    generatePages(bTypeScript: boolean = false): string[] {
        return Object.values(this._pages).map(oP => oP.generate(bTypeScript));
    }
