...
export default class CommonPageBuilder extends PageBuilder {
    ...
    private _addBindingMatcherFunction(): StringBuilder {
        const oFunctCode = new StringBuilder();
        oFunctCode
            .addTab(2)
    ...
    private _generateDependencies(): StringBuilder {
        const oDependencies = new StringBuilder();
    ...
    private _generateActionFunctions(): StringBuilder {
        const oActions = new StringBuilder();
    ...
    private __generateEnterTextFunction(): string {
        const oEnterText = new StringBuilder();
        oEnterText
            .addTab(2)
    ...
    private __generatePressFunction(): string {
        const oPress = new StringBuilder();
        oPress
            .addTab(2)
    ...
    private _generateAssertionFunctions(): StringBuilder {
        const oAssertFunctions = new StringBuilder();
    ...
    private _renderExistsFunction(): string {
        const oExists = new StringBuilder();
        oExists
            .addTab(2)
    ...
    private _renderAttributesFunction(): string {
        const oAttributes = new StringBuilder();
        oAttributes
            .addTab(2)
    ...
    private _renderEmptyAggFunction(): string {
        const oAggEmpty = new StringBuilder();
        oAggEmpty
            .addTab(2)
    ...
    private _renderFilledAggFunction(): string {
        const oAggFilled = new StringBuilder();
        oAggFilled
            .addTab(2)
    ...
    private _renderCountAggFunction(): string {
        const oAggCount = new StringBuilder();
        oAggCount
            .addTab(2)
